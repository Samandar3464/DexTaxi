...
insert into auto_category(name) values ('Volkswagen');
insert into auto_category(name) values ('Chevrolet');
insert into auto_category(name) values ('Ford');
insert into auto_category(name) values ('Mazda');
insert into auto_category(name) values ('Audi');
insert into auto_category(name) values ('Kia');
insert into auto_category(name) values ('Hyudai');
insert into auto_category(name) values ('Honda');
insert into auto_category(name) values ('Mercedes-Benz');
insert into auto_category(name) values ('Volvo');
insert into auto_category(name) values ('Daewoo');
insert into auto_category(name) values ('Lexus');
insert into auto_category(name) values ('Nissan');
insert into auto_category(name) values ('Opel');
insert into auto_category(name) values ('Tesla');
insert into auto_category(name) values ('Lada');
